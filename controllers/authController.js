 ...
 * @param {object} req HTTP request object @note it expected that the user object well be in the body of the req 
 * @param {object} res response Object (JSEND) containing  the created user Object and the token for that specific user 
 */
 ...
 * @param {object} res response Object (JSEND) containing the user and the token  
 */
...
exports.protect = (req, res, next) => {
     ...
     * @param {object} decodedPayLoad is the payload result from the algorathem it contain the id od the object and other info about the token 
     * 
     */
