  ...
  <div class="popup-container" >
    ...
    <div class="popup">
        <label for="login-popup" class="transparent-label"></label>
          <div class="popup-content" style={{borderRadius: '.6rem', fontSize: '16pt', color: 'black', padding: '30px', backgroundColor: 'white', margin: 'auto', width: '750px',position: 'relative', top: '320px' ,height: '360px', textAlign: 'center'}}>
